# Fishing detection model providing trained model files (pt format) and process files.

# Body

Fishing detection model, providing trained model files (pt format) and process files, with 1800 datasets, clear images, complete annotations, suitable for target detection, project experiments, learning research, etc., can be directly used after receiving it, convenient and worry-free
